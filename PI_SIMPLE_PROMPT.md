...
- At the start, inspect the complete RR and make a checklist containing every populated domain from `rr-validation.json`; the domain list is a coverage floor, not a controller-chosen execution order.
